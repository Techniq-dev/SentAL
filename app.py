...
data = pd.read_csv(r'reviews_dataset2.csv', encoding= 'unicode_escape')
...
auth.set_access_token('1321517957348876289-EBnDqUJvgrj8Lx0SOzd56OZbflpmkf', 'o8sgu7ha9iDBkvnv33F76CePHscEUsBgbFwNKpEIwfp4g') 
...
def predict_tweets():    
    ...
    return render_template('pie-chart-twitter.html', data=data, negoutputs = negoutput, posoutputs = posoutput,output_cat1 = output_cat1, output_cat2 = output_cat2, output_cat3 = output_cat3, output_cat4 = output_cat4, Internet=Internet, Network = Network, Customer= Customer, Other = Other, tweetcnt=tweetcnt, cat1 = cat1, cat2 = cat2, cat3 = cat3, cat4 = cat4)
...
def predict():
    ...
    Customer = {'Task' : 'Customer', 'Positive' : cat3_poscnt, 'Negative' : cat3_negcnt}
    Other = {'Task' : 'Other', 'Positive' : cat4_poscnt, 'Negative' : cat4_negcnt}
    return render_template('pie-chart-user.html', data=data, negoutputs = negoutput, posoutputs = posoutput, output_cat1 = output_cat1, output_cat2 = output_cat2, output_cat3 = output_cat3, output_cat4 = output_cat4, Internet=Internet, Network = Network, Customer= Customer, Other = Other, tweetcnt=tweetcnt, cat1 = cat1, cat2 = cat2, cat3 = cat3, cat4 = cat4)
